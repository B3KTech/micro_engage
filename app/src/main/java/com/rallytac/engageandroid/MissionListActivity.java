...
public class MissionListActivity extends AppCompatActivity
{
    ...
    private class MissionListAdapter extends ArrayAdapter<DatabaseMission>
    {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
        {
            ...
            {
                convertView.findViewById(R.id.ivDeleteMission).setVisibility(View.VISIBLE);
            }
            else
            {
    ...
    private void promptToGenerateMission()
    {
        ...
        @SuppressLint({"StringFormatInvalid", "LocalSuppress"}) String title = String.format(getResources().getString(R.string.passphrase_title), Globals.getContext().getResources().getInteger(R.integer.opt_min_mission_generate_passphrase_len));
    ...
    */
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent)
    {
        ...
        if(resultCode == RESULT_OK)
        {
            ...
            {
                Globals.getLogger().d("REQEST_CODE", ""+requestCode);//NON-NLS
                ...
                Globals.getLogger().d("REQEST_CODE", requestCode + "\n" + intent.getAction() +" \n" + intent.getExtras());//NON-NLS

            {
                if(intent != null)
                {
                    ...
                    try
                    {
                        ...
                        if(uri != null)
                        {
                            Globals.getLogger().d("INBOUND_DATA_!_NULL",  uri.toString());//NON-NLS
                        ...
                        else
                        {
                            ...
                            {
                                Globals.getLogger().d("INBOUND_INTENT", Arrays.toString(intentResult.getContents().getBytes()));//NON-NLS
