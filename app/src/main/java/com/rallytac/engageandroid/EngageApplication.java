...
public class EngageApplication extends Application implements
    ...
    private final HashMap<String, PresenceDescriptor> _nodes = new HashMap<String, PresenceDescriptor>();
    ...
    */
        ...
        @SuppressLint("HandlerLeak") Handler handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                try {
                    ...
                    @SuppressLint("HandlerLeak") int responseCode = msg.arg1;
    ...
    public int getQrCodeScannerRequestCode() {
        Log.d("REQUEST_CODE", "" + IntentIntegrator.REQUEST_CODE);
