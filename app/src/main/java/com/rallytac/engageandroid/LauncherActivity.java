...
public class LauncherActivity extends AppCompatActivity
{
    ...
    private static final int ACTION_MANAGE_BATTERY_OPTIMIZATION_PERMISSION_REQUEST_CODE= 4242;
    private static final int ACTION_MANAGE_ANDROID_BATTERY_STANDARD_OPT_ACTIVITY_REQUEST_CODE= 4244;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        _wasLauncherRunBefore = (Globals.getSharedPreferences().getBoolean(PreferenceKeys.LAUNCHER_RUN_BEFORE, false));
        ...
        Globals.getSharedPreferencesEditor().commit();
    ...
    {
        int ACTION_MANAGE_ANDROID_PERMISSIONS_REQUEST_CODE = 4243;
